...
export PYTHONUNBUFFERED=1  # Force Python to flush output stream (e.g., for tqdm)
...
# ============================================================
# Monitor Function: Aligned with Script 1 logic, supports progress bar
# ============================================================
run_step () {
    STEP_NAME="$1"
    shift
    ...
    # 2. Execute command
    # Use --output to ensure stats don't redirect stderr, keeping progress bars on screen
