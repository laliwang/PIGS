...
sam_type=$(jq -r '.sam_type' "${CONFIG_JSON}")
...
# ============================================================
# Monitor Function: Supports progress display, CPU/GPU peak stats
# ============================================================
run_step () {
    STEP_NAME="$1"
    shift
...
"CUDA_VISIBLE_DEVICES=${cudaid} python 3_distance_refine_p5f.py \
    --data_folder ${Data_folder} \
    --seg_folder ${Seg_folder} \
    --weight_pth ${Weights_path} \
