...
# Using a unified summary log format
...
# Note: PIGO module requires switching to its directory
cd "${Code_path}/PIGO_module"

run_step "11. PIGO training" \
"CUDA_VISIBLE_DEVICES=${cudaid} python 11_train_scannetpp_ablation.py \
    -s ${Data_folder} \
    -m ${PIGO_folder} \
...
# Steps 14 & 15 require switching to MVSA_module
